/**
 * Instructions
     * Personalize your duck (name, color, height, weight, hair, and etc).
     * Earn coins by winning races and playing minigames.
     * Upgrade your duck's abilities to win more races.
     * Buy items in the shop.
     * Have fun playing with your duck in the playground.
     * Ultimate Goal: Beat "Pablo the Penguin".
**/
// Credit to Kevin23, Also for the week of 12/10, the featured project!
